...
export default function AddTask(props) {
  return (
    ...
    <input onChange={props.inputOnChange} type="text" className='px-7 bg-transparent border-2 border-violet-500 text-white py-4 appearance-none outline-none rounded-sm font-Manrope text-sm' autoFocus/>
